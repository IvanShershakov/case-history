...
//    private Uri imageUri;
    ...
    private String name, illnesses, timeStamp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Добавить информацию");
...
//        });
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AddRecordActivity.this, "Запись добавлена", Toast.LENGTH_SHORT).show();
            }
        });
...
//        Toast.makeText(this, "Запись добавлена! "+id, Toast.LENGTH_SHORT).show();
//          startActivity(new Intent(AddRecordActivity.this, MainActivity.class));
    }
